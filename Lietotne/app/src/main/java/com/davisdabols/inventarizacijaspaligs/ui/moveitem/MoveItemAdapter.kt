...
class MoveItemAdapter(private val onItemClick: (warehouseModel: WarehouseModel) -> Unit) : RecyclerView.Adapter<MoveItemAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MoveItemAdapter.ViewHolder, position: Int) {
